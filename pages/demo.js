...
**S:** 45-year-old male with hx HTN reports chest tightness x2h radiating to L arm, relieved by rest.

**O:** BP 140/90, HR 88, RR 18, SpO2 97% RA. ECG: ST dep II/III/aVF.
  ...
  return (
    <main className="min-h-screen bg-white text-gray-900 p-6 max-w-3xl mx-auto">
      ...
      <p className="mb-6 text-center">
        Click below to simulate a SOAP note from dictation.
      </p>
      <div className="text-center">
        <button onClick={generateNote} className="bg-blue-600 text-white px-6 py-3 rounded-2xl text-lg shadow-lg hover:bg-blue-700">
